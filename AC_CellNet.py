...
more sense to conceive of neighbor-relationships as social ties that 
transcend space.
...
class CellNet:
	...
	def __init__(self, VARS):
		...
		self.distribute_onto_grid(self.VARS.CELLS, type)
	...
	def get_random_cell(self, who=None):
		...
		return self.VARS.RNG.sample(candidates, 1)[0]
